...
def output(request):
    train = pd.read_csv(r"C:\Users\colem\OneDrive\Documents\Intrusion-Detector-master\logic\Train_data.csv")
    test = pd.read_csv(r"C:\Users\colem\OneDrive\Documents\Intrusion-Detector-master\logic\Test_data.csv")
...
# extract numerical attributes and scale it to have zero mean and unit variance  
    ...
    print("Feature selection complete splitting data into train and test")
    ...
    if request.method =='POST':
        ...
        dstbytes=float(request.POST.get('dstbytes', False))
